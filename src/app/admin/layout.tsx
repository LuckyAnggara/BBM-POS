...
import { Users, Package, Settings, ChevronRight, ListTree, WalletCards, Home } from 'lucide-react';
  ...
  return (
    <AppShell>
      <div className="flex flex-col gap-6">
        {/* The main title "Admin Panel" can be set by individual admin pages using usePageTitle */}
